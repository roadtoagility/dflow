...
namespace Program.Tests
{
    public class ProjectionTests
    {
        ...
        public void ShouldUpdateProductCatalogView()
        {
            ...
            handler.Execute(new CreateProductCommand(rootId, Guid.NewGuid(), "Notebook 2 em 1 Dell", "Notebook Lenovo 2 em 1 ideapad C340 i7-8565U 8GB 256GB SSD Win10 14' FHD IPS - 81RL0001BR"));
