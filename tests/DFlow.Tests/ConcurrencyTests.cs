...
namespace DFlow.Tests
{
    public class ConcurrencyTests
    {
        ...
        public void ShouldMergeEvents()
        {
            ...
            handler.Execute(new CreateProductCommand(rootId, prodId, "Notebook Lenovo 2 em 1 ideapad C340",
            ...
            threads.Add(Task.Run(() =>
            {
                ...
                handlerThread1.Execute(new CreateProductCommand(rootId, Guid.NewGuid(), "Notebook 2 em 1 Dell",
            ...
            var productChanged = (ProductNameChanged)stream.Events.Where(x => x.GetType() == typeof(ProductNameChanged))
                .FirstOrDefault();
        ...
        public void ShouldThrowExceptionConflictEvents()
        {
            ...
            user1.CreateProduct(new CreateProductCommand(rootId, Guid.NewGuid(), "Notebook Asus Vivobook",
            ...
            eventStore.AppendToStream<ProductCatalogAggregate>(user1.Id, user1.Version, user1.Changes,
                user1.DomainEvents.ToArray());

            user2.CreateProduct(new CreateProductCommand(rootId, Guid.NewGuid(), "Notebook 2 em 1 Dell",
                "Notebook 2 em 1 Dell Inspiron i14-5481-M11F 8ª Geração Intel Core i3 4GB 128GB SSD 14' Touch Windows 10 Office 365 McAfe"));
